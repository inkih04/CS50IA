...
# B says nothing.
knowledge1 = And(
    Implication(AKnight, And(AKnave,BKnave)), # AC -> (AB ^ BB)
    Implication(AKnave, Not(And(AKnave,BKnave))), #AB -> 7(AB ^ BB)
    knowledgeBase,
...
imp = Or(Implication(AKnight,AKnave), Implication(AKnave, Not(AKnave)))
...
knowledge3 = And(
    ...
    Or(Implication(BKnight, imp), Implication(BKnave, Not(imp))),
